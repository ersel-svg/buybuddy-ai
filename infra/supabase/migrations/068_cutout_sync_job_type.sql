-- Migration: Add local_cutout_sync job type for background cutout sync
-- Description: Enables background processing for cutout sync operations
-- Date: 2026-01-27

-- Drop existing constraint
ALTER TABLE jobs DROP CONSTRAINT IF EXISTS jobs_type_check;

-- Add new constraint with local_cutout_sync type
